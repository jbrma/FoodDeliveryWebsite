...
foreach ($productos as $producto) {
    ...
    if($owner===$nombreUsuario){
        ...
        $URL= RUTA_APP."/cafeteriaDetail.php?producto=$nombre&cafeNombre=$cafeteriaNombre";
        $contenidoPrincipal.=<<<EOF
        <form method="POST" id="formVerProducto" action="$URL">
        <input type="hidden" name="cafeteriaNombre" value="$cafeteriaNombre">
        <input type="hidden" name="nombreProdcuto" value="$nombre">
        <input type="hidden" name="precio" value="$precio">
        <input type="hidden" name="foto" value="$foto_URL">
