...
class FormularioEliminarCafeteria extends Formulario{
    private $name;
 
    public function __construct($name) {
        $this->name = $name;
       
        parent::__construct('formdeleteCafe', ['urlRedireccion' => Aplicacion::getInstance()->resuelve('/admin.php?action=cafeteria')]); 
    }
    ...
    protected function generaCamposFormulario(&$datos)
    {
        ...
        <input type="submit" value="Eliminar Cafeteria">
