    ...
    <a href="<?= RUTA_APP ?>/index.php">Inicio</a> <br> <br>
		...
		<?php
			if ($status == 0) {	
				...
				echo ' <a href="./registro.php"> Registrarse </a> <br> <br>';

			} 
			else {
				echo ' <a href="' . RUTA_APP . '/cafeteriaDetail.php?owner=' . (isset($_SESSION['nombre']) ? urlencode($_SESSION['nombre']) : '') . '"> Mi cafetería </a> <br> <br>';
